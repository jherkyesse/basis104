...
function Selection({ options = [], verticalClassName, itemValue, itemText, setValue }) {
	return (
...
export default function Dropdown({ options = [], defaultValue = '', required = false, label = '', placeholder = '', itemText = 'text', itemValue = 'value' }) {
